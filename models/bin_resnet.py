...
def centernet(num_classes, backbone='resnet50', input_size=512, max_objects=100, score_threshold=0.1,
    ...
    # binary版のresnet
    resnet = BinaryResNetE18(input_tensor=image_input, include_top=False)
    ...
    for i in range(3):
        ...
        x = lq.layers.QuantConv2DTranspose(num_filters, (4, 4), strides=2, use_bias=False, padding='same',
                            kernel_initializer='he_normal',
                            kernel_regularizer=l2(5e-4), **kwargs)(x)
